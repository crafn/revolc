...
REVOLC_API U32 socket_send(Socket sock, IpAddress addr, const void *data, U32 size);
REVOLC_API U32 socket_recv(Socket sock, IpAddress *addr, void *dst, U32 dst_size);
