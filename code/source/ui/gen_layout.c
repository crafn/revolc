void load_layout(GuiContext *ctx)
{
	...
	gui_update_layout_property(ctx, "gui_bar", "size_y", 22);

	gui_update_layout_property(ctx, "gui_checkbox", "size_x", 18);
	gui_update_layout_property(ctx, "gui_checkbox", "size_y", 18);
	...
	gui_update_layout_property(ctx, "model_settings", "size_x", 247);
	gui_update_layout_property(ctx, "model_settings", "size_y", 463);
	gui_update_layout_property(ctx, "model_settings", "offset_x", 0);
	gui_update_layout_property(ctx, "model_settings", "offset_y", 534);
	...
	gui_update_layout_property(ctx, "world_tools", "size_y", 997);
	...
	gui_update_layout_property(ctx, "gui_slider_y", "size_x", 15);
	...
	gui_update_layout_property(ctx, "gui_contextmenu", "resize_to_min_y", 1);
	gui_update_layout_property(ctx, "gui_contextmenu", "resize_to_min_x", 1);
	...
	gui_update_layout_property(ctx, "gui_client", "gap_y", 3);

	gui_update_layout_property(ctx, "nodegroupdef_list", "size_x", 102);
	gui_update_layout_property(ctx, "nodegroupdef_list", "size_y", 383);
	gui_update_layout_property(ctx, "nodegroupdef_list", "offset_x", 1133);
	gui_update_layout_property(ctx, "nodegroupdef_list", "offset_y", 72);

	gui_update_layout_property(ctx, "panel", "size_x", 100);
	gui_update_layout_property(ctx, "panel", "size_y", 997);
