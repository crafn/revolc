...
QC_API int qc_biop_prec(QC_Token_Type type);
QC_API int qc_biop_assoc(QC_Token_Type type);
...
QC_API QC_AST_Scope *qc_parse_tokens(	QC_Token *toks,
...
QC_API QC_AST_Scope *qc_parse_string(QC_AST_Node **expr, const char *string);
